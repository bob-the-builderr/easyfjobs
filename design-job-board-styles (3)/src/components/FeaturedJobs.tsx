...
{job.salary ? (
  ...
  <p className="text-sm font-semibold text-muted-foreground">Salary not listed</p>
        ...
        <a
          href={job.application_url || `/jobs/${job.slug}`}
  ...
  return (
    <section className="pt-3 pb-3 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Carousel - Hidden on sm and larger */}
        <div className="overflow-x-auto sm:hidden -mx-4 px-4 pb-2">
        ...
        {/* Desktop Grid - Hidden on mobile, visible on sm and larger */}
